...
<div class="col-md-8">
    ...
    <div class="form-group row">
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('alamat')) ? 'is-invalid' : ''; ?>" id="alamat" name="alamat" placeholder="alamat" value="<?= (set_value('alamat')) ? set_value('alamat') : $data->alamat; ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('hp')) ? 'is-invalid' : ''; ?>" id="hp" name="hp" placeholder="hp" value="<?= (set_value('hp')) ? set_value('hp') : $data->hp; ?>">
            <div class="invalid-feedback">
